...
function Cell(props) {
    ...
    return (
        <div class = "col" style={{textAlign: "center", backgroundColor: (!(props.state.isRevealed || props.state.isFlagged) && "#a6a5a5")}} onClick={handleClick} onContextMenu={handleRightClick}>{getSymbol()}</div>
    );
}
export default Cell;